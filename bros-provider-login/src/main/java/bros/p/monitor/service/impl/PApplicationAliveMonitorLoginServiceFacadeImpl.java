...
/**
 * 
 * @ClassName: PApplicationAliveMonitorLoginServiceFacadeImpl 
 * @Description: 监听bros-provider-login模块是否存活
 * @author 何鹏
 * @date 2016年12月19日 下午12:12:39 
 * @version 1.0
 */
@Component("papplicationAliveMonitorLoginServiceFacade")
public class PApplicationAliveMonitorLoginServiceFacadeImpl implements
		IPApplicationAliveMonitorLoginServiceFacade {
	private static final Logger logger = LoggerFactory.getLogger(PApplicationAliveMonitorLoginServiceFacadeImpl.class);
	@Autowired
	...
	public List<Map<String,Object>> applicationAliveMonitorMethod(
	    ...
	    String modelName = "bros-provider-login";
