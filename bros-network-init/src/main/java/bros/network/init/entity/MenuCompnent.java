package bros.network.init.entity;
	...
	*/
	...
	public Menu mainMenuConstructor(){
		...
		*/
		...
		cacheDataList.add(2, cacheDataErrorCodeMenu);
		cacheDataList.add(3, cacheDataAppParMenu);
		cacheDataList.add(4, cacheDataPropertiesMenu);
		cacheDataList.add(5, cacheDataValidationMenu);
		//cacheDataList.add(7, dbDataActivitiMenu);
		cacheDataList.add(6, authTemplateGetMenu);
		...
		mainlist.add(3,errorCodeMenu);//初始化错误码
		mainlist.add(4,appParMenu);//初始化转义数据
		mainlist.add(5,propertiesMenu);//初始properties文件
		mainlist.add(6,cacheDataMenu);//初始化获取缓存数据
		mainlist.add(7,validationMenu);//初始化校验模板文件
		//mainlist.add(9,activitiMenu);//初始化工作流
		mainlist.add(8,authTemplateMenu);//授权详情数据
