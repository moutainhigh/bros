...
/**
 * 
 * @ClassName: PApplicationAliveMonitorTransferServiceFacadeImpl 
 * @Description: 监听bros-provider-transfer模块是否存活
 * @author 何鹏
 * @date 2016年12月19日 下午2:03:20 
 * @version 1.0
 */
@Component("papplicationAliveMonitorTransferServiceFacade")
public class PApplicationAliveMonitorTransferServiceFacadeImpl implements
		IPApplicationAliveMonitorTransferServiceFacade {
	private static final Logger logger = LoggerFactory.getLogger(PApplicationAliveMonitorTransferServiceFacadeImpl.class);
	@Autowired
	...
	public List<Map<String,Object>> applicationAliveMonitorMethod(
	    ...
	    String modelName = "bros-provider-transfer";
