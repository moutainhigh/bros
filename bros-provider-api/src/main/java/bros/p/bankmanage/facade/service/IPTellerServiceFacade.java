 ...
 * @version V1.0  
 */
public interface IPTellerServiceFacade {
	/**
	 * 
	 * @Title: addTeller 
	 * @Description: 增加柜员
	 ...
	 * @throws ServiceException
	 */
    public ResponseEntity tellerLogin(Map<String,Object> headMap,Map<String, Object> bodyMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
    public ResponseEntity tellerLogout(Map<String,Object> headMap,Map<String, Object> bodyMap) throws ServiceException;
