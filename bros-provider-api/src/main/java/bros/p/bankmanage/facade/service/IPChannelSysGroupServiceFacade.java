...
/**
 * 
 * @ClassName: IPChannelSysGroupServiceFacade 
 * @Description: 渠道系统分组对外接口
 * @author gaoyongjing 
 * @date 2016年6月27日 下午15:35:28 
 * @version 1.0
 */
public interface IPChannelSysGroupServiceFacade {
	/**
	 * 
	 ...
	 * @Description:新增pub_channel渠道系统分组
	 * @param headMap  头信息
	 * @param paramMap 渠道分组信息包含以下参数
	 * @param legalPersonId  法人ID
	 * @return ResponseEntity 
	 ...
	 * @Description:删除pub_channel渠道系统分组
	 * @param headMap  头信息
	 * @param paramMap 渠道分组信息包含以下参数
	 * @param legalPersonId  法人ID
	 * @return ResponseEntity 
	 ...
	 * @Description:修改pub_channel渠道系统分组
	 * @param headMap  头信息
	 * @param paramMap 渠道分组信息包含以下参数
	 * @param legalPersonId  法人ID
	 * @return ResponseEntity 
	 ...
	 * @Description:查询pub_channel渠道系统分组
	 * @param headMap  头信息
	 * @param paramMap 渠道分组信息包含以下参数
	 * @param legalPersonId  法人ID
	 * @return ResponseEntity 
