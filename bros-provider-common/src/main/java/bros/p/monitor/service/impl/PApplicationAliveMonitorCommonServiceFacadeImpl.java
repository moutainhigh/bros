...
/**
 * 
 * @ClassName: PApplicationAliveMonitorCommonServiceFacadeImpl 
 * @Description: 监听bros-provider-common模块是否存活
 * @author 何鹏
 * @date 2016年12月19日 下午12:00:19 
 * @version 1.0
 */
@Component("papplicationAliveMonitorCommonServiceFacade")
public class PApplicationAliveMonitorCommonServiceFacadeImpl implements
		IPApplicationAliveMonitorCommonServiceFacade {
	private static final Logger logger = LoggerFactory.getLogger(PApplicationAliveMonitorCommonServiceFacadeImpl.class);
	@Autowired
	...
	public List<Map<String,Object>> applicationAliveMonitorMethod(
	    ...
	    String modelName = "bros-provider-common";
