 ...
 * 
 * @ClassName: Crc32Util 
 * @Description: crc32报文校验工具
 * @author 何鹏
 * @date 2016年8月22日 下午1:57:55 
 * @version 1.0
 */
public class Crc32Util {
	...
	/**
	 * 
	 * @Title: getFixedLengthCrc 
	 * @Description: 获取8位长度的校验位
	 * @param message
	 * @return
	 */
	public static String getFixedLengthCrc(String message){
		String crc = getCRC32(message);
		if(crc.length()>= 8){
			crc = crc.substring(0,8);
		}else{
			int reduce = 8-crc.length();
			String sub = "00000000";
			crc = sub.substring(0,reduce)+crc;
		}
		return crc;
	}

	public static void main(String[] args) {
		String str = "我扫地发哦打发技术的覅U阿道夫啊师傅对啊速度发撒U地方啊时代发生的发生地方aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
