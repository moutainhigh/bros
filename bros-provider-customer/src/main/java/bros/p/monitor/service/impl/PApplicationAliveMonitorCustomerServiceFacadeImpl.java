...
/**
 * 
 * @ClassName: PApplicationAliveMonitorCustomerServiceFacadeImpl 
 * @Description: 监听bros-provider-customer模块是否存活
 * @author 何鹏
 * @date 2016年12月19日 下午12:06:29 
 * @version 1.0
 */
@Component("papplicationAliveMonitorCustomerServiceFacade")
public class PApplicationAliveMonitorCustomerServiceFacadeImpl implements
		IPApplicationAliveMonitorCustomerServiceFacade {
	private static final Logger logger = LoggerFactory.getLogger(PApplicationAliveMonitorCustomerServiceFacadeImpl.class);
	@Autowired
	...
	public List<Map<String,Object>> applicationAliveMonitorMethod(
	    ...
	    String modelName = "bros-provider-customer";
