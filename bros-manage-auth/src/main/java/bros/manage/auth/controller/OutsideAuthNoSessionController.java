...
public class OutsideAuthNoSessionController extends CommonNoSessionController{
	private static final  Logger logger = LoggerFactory.getLogger(OutsideAuthNoSessionController.class);
	/**
	 * 通讯服务
	 */
	@Autowired
	 ...
	 */
	@RequestMapping(value = "/getOutSideAuthProcessPhoto",method=RequestMethod.GET)
	public void getOutSideAuthProcessPhoto(HttpServletRequest request,HttpServletResponse response) throws ServiceException {
		File file = null;
	    try {
