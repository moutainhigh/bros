...
import bros.c.bankmanage.facade.service.ICChannelSysInfoServiceFacade;
...
/**
 * 
 * @ClassName: CChannelSysInfoServiceFacadeImpl 
 * @Description: 渠道系统对外接口
 * @author gaoyongjing 
 * @date 2016年6月28日 下午15:35:28 
 * @version 1.0
 */
@Component("cchannelSysInfoServiceFacade")
public class CChannelSysInfoServiceFacadeImpl implements ICChannelSysInfoServiceFacade {
	/**
	 * 渠道系统服务
	 */
	@Autowired
	private IPChannelSysInfoServiceFacade pchannelSysInfoServiceFacade;
	...
	public ResponseEntity addChannelSysInfoMethod(Map<String, Object> headMap,
		...
		return pchannelSysInfoServiceFacade.addChannelSysInfoMethod(headMap, paramMap);
	}
	...
	public ResponseEntity updateChannelSysInfoMethod(
		...
		return pchannelSysInfoServiceFacade.updateChannelSysInfoMethod(headMap, paramMap);
	}
	/**
	 * 
	...
	public ResponseEntity updateChannelSysStatusMethod(Map<String, Object> headMap, Map<String, Object> paramMap) throws ServiceException{
		return pchannelSysInfoServiceFacade.updateChannelSysStatusMethod(headMap, paramMap);
	}
	/**
	 * 
	...
	public ResponseEntity deleteChannelSysInfoMethod(
			Map<String, Object> headMap, Map<String, Object> paramMap)
			throws ServiceException {
		return pchannelSysInfoServiceFacade.deleteChannelSysInfoMethod(headMap, paramMap);
	}
	...
	public ResponseEntity queryChannelSysInfoMethod(Map<String, Object> headMap, Map<String, Object> paramMap)
			throws ServiceException {
		return pchannelSysInfoServiceFacade.queryChannelSysInfoMethod(headMap, paramMap);
	}
	/**
	 * 
	...
	public ResponseEntity queryChannelSysInfoPageMethod(Map<String, Object> headMap, Map<String, Object> paramMap)throws ServiceException{
		return pchannelSysInfoServiceFacade.queryChannelSysInfoPageMethod(headMap, paramMap);
	}
}
