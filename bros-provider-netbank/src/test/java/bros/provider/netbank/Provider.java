...
public class Provider {
	...
	public static void main(String[] args) throws Exception {
		...
		//ApplicationContext context = new FileSystemXmlApplicationContext("D:\\workspace\\channelWorkspace\\bros-provider-netbank\\target\\classes\\spring\\spring-context.xml");
		//初始化报文
		//initFormat();
		//初始化校验文件
		//initValidation();
