...
/**
 * 
 * @ClassName: PApplicationAliveMonitorNetbankServiceFacadeImpl 
 * @Description: 监听bros-provider-netbank模块是否存活
 * @author 何鹏
 * @date 2016年12月19日 下午12:15:33 
 * @version 1.0
 */
@Component("papplicationAliveMonitorNetbankServiceFacade")
public class PApplicationAliveMonitorNetbankServiceFacadeImpl implements
		IPApplicationAliveMonitorNetbankServiceFacade {
	@Autowired
	...
	public List<Map<String,Object>> applicationAliveMonitorMethod(
	    ...
	    String modelName = "bros-provider-netbank";
